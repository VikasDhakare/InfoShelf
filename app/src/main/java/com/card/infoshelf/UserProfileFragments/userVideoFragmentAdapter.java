...
public class userVideoFragmentAdapter extends RecyclerView.Adapter<userVideoFragmentAdapter.MyViewHolder> {
    private Context context;
    public List<GridModel> videoArray;

    public userVideoFragmentAdapter(Context context, List<GridModel> videoArray) {
